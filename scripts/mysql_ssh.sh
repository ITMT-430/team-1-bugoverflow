...
sleep 30
ssh -i /team-1-bugoverflow/scripts/EUCA-BUG-OVERFLOW.pem root@64.131.111.27 -o StrictHostKeyChecking=no "cd .."
...
ssh -i /team-1-bugoverflow/scripts/EUCA-BUG-OVERFLOW.pem root@64.131.111.27 -o StrictHostKeyChecking=no "/bin/bash /team-1-bugoverflow/scripts/mysql_master.sh"
